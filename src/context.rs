...
use arm_sysregs::{
    ...
    read_amair_el2, read_cnthctl_el2, read_cntvoff_el2, read_cptr_el2, read_elr_el2, read_esr_el2,
    read_far_el2, read_hacr_el2, read_hcr_el2, read_hpfar_el2, read_hstr_el2, read_icc_sre_el2,
    read_ich_hcr_el2, read_ich_vmcr_el2, read_mair_el2, read_mdcr_el2, read_sctlr_el2, read_sp_el2,
    read_spsr_el2, read_tcr_el2, read_tpidr_el2, read_ttbr0_el2, read_vbar_el2, read_vmpidr_el2,
    read_vpidr_el2, read_vtcr_el2, read_vttbr_el2, write_actlr_el2, write_afsr0_el2,
    write_afsr1_el2, write_amair_el2, write_cnthctl_el2, write_cntvoff_el2, write_cptr_el2,
...
fn initialise_common(context: &mut CpuContext, entry_point: &EntryPointInfo) {
    ...
    // and when the processor supports ECV. FEAT_ECV is mandatory since ARMv8.6.
    //
    // NOTE: Modifying EEL2 bit along with EA bit ensures that we mitigate
    // against ERRATA_V2_3099206.
    context.el3_state.scr_el3 =
        ScrEl3::RES1 | ScrEl3::HCE | ScrEl3::SIF | ScrEl3::RW | ScrEl3::FGTEN | ScrEl3::ECVEN;
    #[cfg(feature = "sel2")]
    {
