...
use crate::{
    ...
    smccc::SmcReturn,
    sysregs::{Esr, ScrEl3, Spsr, read_mpidr_el1, write_scr_el3, cptr_el3},
};
...
static PER_WORLD_CONTEXT: PerWorld<PerWorldContext> = PerWorld::<PerWorldContext>([
        ...
        PerWorldContext { cptr_el3: cptr_el3::TAM | cptr_el3::TTA | cptr_el3::ESM | cptr_el3::EZ, zcr_el3: 0xF },
        // Normal world context
        PerWorldContext { cptr_el3: cptr_el3::ESM | cptr_el3::EZ, zcr_el3: 0xF },
        // Realm world context
        #[cfg(feature = "rme")]
        PerWorldContext { cptr_el3: cptr_el3::TAM | cptr_el3::TTA | cptr_el3::ESM | cptr_el3::EZ, zcr_el3: 0xF }]
);
