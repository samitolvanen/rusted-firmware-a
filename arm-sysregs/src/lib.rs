...
bitflags! {
    ...
    pub struct MdcrEl3: u64 {
        ...
        /// EL1 to EL3.
        const TTRF = 1 << 19;
        /// ecure Cycle Counter Disable. Prohibits PMCCNTR_EL0 from counting in Secure state.
        const SCCD = 1 << 23;
...
impl IdAa64dfr0El1 {
    ...
    /// Multi Threaded PMU Extension version.
    pub const MULTI_THREADED_PMU_MASK: Self = Self::from_bits_retain(0xf << 48);
}
