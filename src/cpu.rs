...
/// # Safety
///
/// The `reset_handler` function must be implemented as a naked function or an empty function. It
/// should only clobber X0-X18, and X30 registers. It must not use the stack, because it might be
/// called at a point when the stack has not been configured.
