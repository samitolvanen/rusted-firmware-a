...
impl From<TestHelperRequest> for Phase {
    fn from(value: TestHelperRequest) -> Self {
        match value {
            [0, ..] => Phase::SWdOverwriteSIMD,
            [1, ..] => Phase::SWdCheckSIMD,
            _ => unreachable!(),
        }
    }
}
...
fn test_simd_context_switch_helper(
    ...
    match Phase::from(ns_world_request) {
