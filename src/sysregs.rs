...
read_sysreg!(id_aa64mmfr2_el1, u64: Aa64mmfr2El1, safe read_id_aa64mmfr2_el1);
...
read_sysreg!(ccsidr_el1, u64, safe read_ccsidr_el1);
read_sysreg!(clidr_el1, u64: ClidrEl1, safe read_clidr_el1);
...
read_write_sysreg!(csselr_el1, u64: CsselrEl1, safe read_csselr_el1, safe write_csselr_el1);
read_sysreg!(ctr_el0, u64: CtrEl0, safe read_ctr_el0);
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct Aa64mmfr2El1(u64);

bitflagslike!(Aa64mmfr2El1: u64);
...
impl Aa64mmfr2El1 {
    ...
    pub fn has_64_bit_ccsidr_el1(self) -> bool {
        (self.0 >> Self::CCIDX_SHIFT) & Self::CCIDX_MASK == Self::CCIDX_64_BIT
    }
}
...
impl ClidrEl1 {
    ...
    pub fn icb(self) -> Option<CacheLevel> {
        let icb = (self.0 >> Self::ICB_SHIFT) & Self::LEVEL_MASK;
        if icb != 0 {
...
impl CsselrEl1 {
    ...
    pub fn tnd(self) -> bool {
        (self.0 & Self::TND_BIT) != 0
    }

    /// Cache level of required cache.
    pub fn level(self) -> CacheLevel {
        ((self.0 >> Self::LEVEL_SHIFT) & Self::LEVEL_MASK).into()
    }

    /// Instruction not Data bit.
    pub fn ind(self) -> bool {
        (self.0 & Self::IND_BIT) != 0
    }
}
