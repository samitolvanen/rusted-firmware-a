...
/// Converts a list of memory regions into a list of `DescriptorRange`.
...
pub const fn get_range_count(regions: &[(Range<usize>, usize)]) -> usize {
...
/// region list at the table of the tree.
...
/// Builds the early page tables from `EARLY_PAGETABLE_RANGES`.
#[unsafe(naked)]
#[unsafe(no_mangle)]
...
mod tests {
    ...
    #[test]
    fn map_level0() {
        const REGIONS: [(Range<usize>, usize); 1] = [(0x8000_0000..0xC000_0000, 0x10)];
    ...
    #[test]
    fn map_level1() {
        const REGIONS: [(Range<usize>, usize); 1] = [(0x8000_0000..0x8040_0000, 0x20)];
    ...
    #[test]
    fn map_level2() {
        const REGIONS: [(Range<usize>, usize); 1] = [(0x8000_0000..0x8000_3000, 0x30)];
    ...
    #[test]
    fn map_complex() {
        const REGIONS: [(Range<usize>, usize); 3] = [
            (0x0000_0000..0x4000_0000, 0x10),
            (0x4000_0000..0x4040_0000, 0x20),
            (0x8000_0000..0x8000_3000, 0x30),
        ];
