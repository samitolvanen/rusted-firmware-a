...
impl Arch {
    ...
    fn handle_common_smc(regs: &mut SmcReturn) {
        ...
        match function.0 {
            SMCCC_VERSION => regs.set_single(version().into()),
            ...
            _ => regs.set_single(NOT_SUPPORTED.into()),
        }
    }
}
...
fn arch_soc_id(regs: &mut SmcReturn, call_type: SmcccCallType) {
    ...
    match soc_id_type {
        SMCCC_ARCH_SOC_ID_VERSION => regs.set_single(0.into()), // TODO: Implement this properly.
        SMCCC_ARCH_SOC_ID_REVISION => regs.set_single(0.into()), // TODO: Implement this properly.
        ...
        _ => regs.set_single(INVALID_PARAMETER.into()),
    }
}
