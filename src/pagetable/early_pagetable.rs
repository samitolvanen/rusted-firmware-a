...
/// `DescriptorRange` array and the required size of the page tables after extracting them from the
...
/// `regions`. It behahaves like it is building actual page tables recursively but it only sets the
/// the items of `ranges`.
///
