...
read_write_sysreg!(gcr_el1, u64, safe_read, safe_write, fake::SYSREGS);
...
read_write_sysreg!(rgsr_el1, u64, safe_read, safe_write, fake::SYSREGS);
...
read_write_sysreg!(tfsr_el1, u64, safe_read, safe_write, fake::SYSREGS);
read_write_sysreg!(tfsr_el2, u64, safe_read, safe_write, fake::SYSREGS);
read_write_sysreg!(tfsre0_el1, u64, safe_read, safe_write, fake::SYSREGS);
