...
/// stack and don't access memory. They can clobber registers from x0 up to and including x5.
...
///
/// Clobbers registers from x0 up to and including x6.
///
...
/// Clobbers registers from x0 up to and including x5 as well as x9, x10, x11.
