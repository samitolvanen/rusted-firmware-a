...
mod tests {
    ...
    fn vmm_init_and_enable() {
        ...
        // Safety: Faking disabled MMU by clearing SCTLR_EL3.
        unsafe {
            vmm.init_and_enable();
        }
    ...
    fn vmm_init_with_mmu() {
        ...
        // Safety: Purposefully faking SCTLR_EL3.M=1 to trigger panic.
        unsafe {
            vmm.init_and_enable();
        }
    }
    ...
    fn vmm_init_twice() {
        ...
        // Safety: Faking disabled MMU by clearing SCTLR_EL3, but calling twice to trigger panic.
        unsafe {
            vmm.init_and_enable();
            vmm.init_and_enable();
        }
