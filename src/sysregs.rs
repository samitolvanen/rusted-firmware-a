...
read_write_sysreg!(actlr_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(actlr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(afsr0_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(afsr0_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(afsr1_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(afsr1_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(amair_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(amair_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(cntfrq_el0, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(cnthctl_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(cntvoff_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(contextidr_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(contextidr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(cpacr_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(cptr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(csselr_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(elr_el1, usize, safe, safe, fake::SYSREGS);
read_write_sysreg!(elr_el2, usize, safe, safe, fake::SYSREGS);
read_write_sysreg!(esr_el1, u64: Esr, safe, safe, fake::SYSREGS);
read_write_sysreg!(esr_el2, u64: Esr, safe, safe, fake::SYSREGS);
read_write_sysreg!(far_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(far_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(hacr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(hcr_el2, u64: HcrEl2, safe, safe, fake::SYSREGS);
read_write_sysreg!(hpfar_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(hstr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(icc_sre_el1, u64: IccSre, safe, safe, fake::SYSREGS);
read_write_sysreg!(icc_sre_el2, u64: IccSre, safe, safe, fake::SYSREGS);
write_sysreg! {
    /// # Safety
    ///
...
read_write_sysreg!(ich_hcr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(ich_vmcr_el2, u64, safe, safe, fake::SYSREGS);
read_sysreg!(isr_el1, u64, safe, fake::SYSREGS);
read_write_sysreg!(mair_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(mair_el2, u64, safe, safe, fake::SYSREGS);
write_sysreg! {
    /// # Safety
    ///
...
read_write_sysreg!(mdccint_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(mdcr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(mdscr_el1, u64, safe, safe, fake::SYSREGS);
read_sysreg!(midr_el1, u64, safe, fake::SYSREGS);
read_write_sysreg!(par_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(scr_el3, u64: ScrEl3, safe, safe, fake::SYSREGS);
read_write_sysreg!(sctlr_el1, u64: SctlrEl1, safe, safe, fake::SYSREGS);
read_write_sysreg!(sctlr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg! {
    /// # Safety
    ///
    ...
    /// requirements.
    sctlr_el3, u64: SctlrEl3, safe, fake::SYSREGS
}
read_write_sysreg!(sp_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(sp_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(spsr_el1, u64: Spsr, safe, safe, fake::SYSREGS);
read_write_sysreg!(spsr_el2, u64: Spsr, safe, safe, fake::SYSREGS);
read_write_sysreg!(tcr_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(tcr_el2, u64, safe, safe, fake::SYSREGS);
write_sysreg! {
    /// # Safety
    ///
    /// The caller must ensure that `value` is a correct and safe configuration value for the EL3
...
read_write_sysreg!(tpidr_el0, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(tpidr_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(tpidr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(tpidrro_el0, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(ttbr0_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(ttbr0_el2, u64, safe, safe, fake::SYSREGS);
write_sysreg! {
    /// # Safety
    ///
...
read_write_sysreg!(ttbr1_el1, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(ttbr1_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(vbar_el1, usize, safe, safe, fake::SYSREGS);
read_write_sysreg!(vbar_el2, usize, safe, safe, fake::SYSREGS);
read_write_sysreg!(vmpidr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(vpidr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(vtcr_el2, u64, safe, safe, fake::SYSREGS);
read_write_sysreg!(vttbr_el2, u64, safe, safe, fake::SYSREGS);
