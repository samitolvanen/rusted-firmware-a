...
use core::{arch::naked_asm, mem::{offset_of, size_of}};
...
/// # Safety
/// Caller must ensure this function is called as early as possible during reset boot flow.
#[unsafe(naked)]
// TODO delete the below and use sym to call that in the relevant place
#[unsafe(no_mangle)]
