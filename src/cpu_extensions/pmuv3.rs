...
pub fn configure_per_cpu(ctx: &mut CpuContext) {
    #[cfg(feature = "sel2")]
    {
        ...
        let mdcr_el2 = ctx.el2_sysregs.mdcr_el2;
        let pmu_event_counter_num = read_pmcr_el0().event_counter_num();
        ctx.el2_sysregs.mdcr_el2 = mdcr_el2.with_hpmn(pmu_event_counter_num)
    }
